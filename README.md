...
This project is a result of workshops in CodersLab Boot camp; 
The instructions for the excersise are shown below. Some additional adjustments were added to the game.
Technologies:
- JavaScript
- HTML
- CSS
